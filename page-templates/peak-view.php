            ...
            <div class="container-fluid products-content wrap push">
                ...
                <div class="container-fluid p-pkg-s-1">
                    <div class="container p-pkg-s-1-wrapper">
                        ...
                        <div class="pkg-house">
                            <img src="<?php the_field('page-img'); ?>" class="pkg-display-img">
                        </div><!-- pkg-house -->
                        ...
                        <div class="row pkg-options">
                            ...
                            <ul class="col-sm-3 pricing-column">
                                <li class="pricing-column-header">
                                    ...
                                    <div class="price">
                                        <span class="amount-view"><?php the_field('pkg-price-1'); ?></span><span class="month"><?php the_field('pkg-monthly'); ?></span>
                                    </div><!-- column-pricing -->
                                    <div class="pkg-term">
                                        <h6 class="term"><?php the_field('pkg-agreement-1'); ?></h6>
                                    </div><!-- pkg-term -->
                                    <div class="pkg-btn">
                                        <a href="<?php the_field('pkg-btn-1'); ?>" class="price-view-btn"><?php the_field('pkg-btn-text-1'); ?></a>
                                    </div><!-- pkg-btn -->
                                </li>
                            ...
                            <ul class="col-sm-3 pricing-column">
                                <li class="pricing-column-header">
                                    ...
                                    <div class="price price-view">
                                        <span class="amount-view"><?php the_field('pkg-price-2'); ?></span><span class="month"><?php the_field('pkg-monthly'); ?></span>
                                    </div><!-- column-pricing -->
                                    <div class="pkg-term">
                                        <h6 class="term"><?php the_field('pkg-agreement-2'); ?></h6>
                                    </div><!-- pkg-term -->
                                    <div class="pkg-btn">
                                        <a href="<?php the_field('pkg-btn-2'); ?>" class="price-view-btn"><?php the_field('pkg-btn-text-2'); ?></a>
                                    </div><!-- pkg-btn -->
                                </li>
                            ...
                            <ul class="col-sm-3 pricing-column">
                                <li class="pricing-column-header">
                                    ...
                                    <div class="price price-view">
                                        <span class="amount-view"><?php the_field('pkg-price-3'); ?></span><span class="month"><?php the_field('pkg-monthly'); ?></span>
                                    </div><!-- column-pricing -->
                                    <div class="pkg-term">
                                        <h6 class="term"><?php the_field('pkg-agreement-3'); ?></h6>
                                    </div><!-- pkg-term -->
                                    <div class="pkg-btn">
                                        <a href="<?php the_field('pkg-btn-3'); ?>" class="price-view-btn"><?php the_field('pkg-btn-text-3'); ?></a>
                                    </div><!-- pkg-btn -->
                                </li>
                                <li class="pricing-column-row odd"><?php the_field('pkg-service-3-1'); ?></li>
                                <li class="pricing-column-row even"><?php the_field('pkg-service-3-2'); ?></li>
                                <li class="pricing-column-row odd"><?php the_field('pkg-service-3-3'); ?></li>
                                <li class="pricing-column-row even"><?php the_field('pkg-service-3-4'); ?></li>
                                <li class="pricing-column-row odd"><?php the_field('pkg-service-3-5'); ?></li>
                                <li class="pricing-column-row even"><?php the_field('pkg-service-3-6'); ?></li>
                                <li class="pricing-column-row odd"><?php the_field('pkg-service-3-7'); ?></li>
                            </ul><!-- pricing-column -->
                        </div><!-- pkg-options -->
                        <div class="pkg-layout-mobile">
                            ...
                            <ul class="col-md-4 pricing-column">
                                <li class="pricing-column-header">
                                    ...
                                    <div class="pkg-btn">
                                        <a href="<?php the_field('pkg-btn-3'); ?>" class="price-btn"><?php the_field('pkg-btn-text-3'); ?></a>
                                    </div><!-- pkg-btn -->
                                </li>
                                <li class="pricing-column-row odd">
                                    <div class="col-sm-6 col-xs-9 p-txt-left">
